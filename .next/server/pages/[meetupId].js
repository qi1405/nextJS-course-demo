...
async function getStaticPaths() {
  const client = await external_mongodb_["MongoClient"].connect("mongodb+srv://jp1405:1405991473029Qi_@cluster0.coppp.mongodb.net/meetups?retryWrites=true&w=majority");
  const db = client.db();
